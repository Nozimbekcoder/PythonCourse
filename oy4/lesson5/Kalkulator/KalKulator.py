...
oyna = Tk()
oyna.title("Kalkulator *Developed by Nozimjon")
oyna.geometry("400x440")
oyna.configure(bg="#00001a")
oyna.resizable(False, False)


# Raqamlar bo'yicha funksiyalar
...
# Raqamlar tugadi______________________________________________________
# amallar
...
def ekr():
    ...
    teng.configure(state=NORMAL, bg='orange')
...
ekran = Entry(oyna, bd=5, font=("Arial 25"), highlightcolor='yellow', justify=RIGHT, width=20)
ekran.place(x=13, y=10)

ce = Button(oyna, text="CE", font=("Arial", 20), bg="orange", fg="white", width=4, command=tozalash)
ce.place(x=10, y=90)
c = Button(oyna, text="C", font=("Arial", 20), bg="orange", fg="white", width=4, command=tozalash)
c.place(x=112, y=90)

tozala = Button(oyna, text="<×", font=("Arial", 20), bg="orange", fg="white", width=4, command=birdel)
...
plmin = Button(oyna, text="±", font=('Arial', 20), bg='orange', fg='white', width=4, command=plminb)
...
teng = Button(oyna, text="=", font=('Arial', 20), bg='orange', fg='white', width=4, command=hisobla)
